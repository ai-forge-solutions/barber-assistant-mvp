...
const sections = [
  {
    title: 'Qué es TURNO.',
    body: 'TURNO. es una herramienta para que barberías gestionen su agenda y permitan a sus clientes reservar citas online. La plataforma no presta servicios de barbería: el corte, la cita y cualquier servicio presencial los presta la barbería correspondiente.',
  },
  {
  ...
  },
  {
    ...
    body: 'TURNO. puede enviar emails transaccionales relacionados con la cuenta, citas, recordatorios, cancelaciones o seguridad. Estas comunicaciones son necesarias para prestar el servicio y no son publicidad general.',
  },
  {
    title: 'Disponibilidad del servicio',
    body: 'Trabajamos para que TURNO. funcione de forma estable, pero pueden existir mantenimientos, incidencias técnicas o interrupciones de proveedores. Cuando una incidencia afecte a reservas o agenda, se intentará reducir el impacto y recuperar el servicio cuanto antes.',
  },
  {
    title: 'Uso correcto',
    body: 'No se permite usar TURNO. para enviar spam, publicar información falsa, acceder a cuentas ajenas, extraer datos de forma abusiva, saltarse medidas de seguridad o realizar actividades ilegales.',
  },
  {
    title: 'Responsabilidad',
    body: 'La barbería es responsable de la prestación presencial del servicio, sus precios, su atención al cliente y el cumplimiento de sus obligaciones legales. TURNO. responde por la herramienta tecnológica en los términos permitidos por la ley aplicable.',
  },
  {
    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto w-full max-w-3xl px-5 py-8">
        ...
        <p className="mt-4 font-['DM_Sans'] text-[15px] leading-relaxed text-[#555555]">
          Estos términos recogen las reglas básicas para usar TURNO. como barbería o como cliente que reserva cita. La idea es sencilla: agenda clara, datos correctos y uso honesto de la plataforma.
        </p>
