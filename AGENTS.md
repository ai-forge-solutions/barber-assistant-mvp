...
Additional reusable worker skills live in `.github/skills/`:

| Skill | Use when |
|---|---|
| `premium-landing-designer` | Creating or substantially reworking premium/conversion-focused marketing pages. |
| `landing-page-design` | Optimizing landing structure, hero, above-the-fold content, CTAs, and conversion flow. |
