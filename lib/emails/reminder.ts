...
/** Returns a plain-text HTML email body for 24h reminder sent to the client */
...
<body style="font-family:sans-serif;background:#f4f4f5;margin:0;padding:24px;">
  <div style="max-width:520px;margin:0 auto;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,0.08);">
    ...
    <div style="padding:32px;">
      <h2 style="font-size:18px;color:#18181b;margin-top:0;">Recordatorio: cita mañana</h2>
      <p style="color:#52525b;margin-bottom:24px;">Hola ${data.clientName}, te recordamos que tienes una cita mañana.</p>
      ...
      <p style="color:#a1a1aa;font-size:12px;margin-top:24px;">El enlace de cancelación caduca en 48 horas desde que se creó la cita.</p>
    </div>
  </div>
</body>
</html>
