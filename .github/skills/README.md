# Worker skills for TURNO. / Barber Assistant
...
| Skill | Use when |
|---|---|
| `frontend-branding` | Mandatory for every visible UI, frontend, copy, dashboard, landing, and public booking-page change. This is the TURNO. design-system source of truth. |
...
These skills are additive. If generic imported guidance conflicts with `frontend-branding`, follow `frontend-branding` and keep TURNO.'s exact palette, typography, radii, tone, and mobile-first constraints.
